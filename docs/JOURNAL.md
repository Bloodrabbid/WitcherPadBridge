...
- Осталось проверить в бою: срабатывает ли `OnCameraShake` достаточно часто и попадает ли
  тик серии ударов в нужный момент. Это уже вопрос настройки таблицы `R.feel`.
